    ...
    if example == 1:
        ...
        with st.sidebar:
            selected = option_menu(
                ...
                options=["BERANDA", "PREDIKSI", "TEAM"],  # required
                icons=["house", "search", "people group"],  # optional
...
if selected == "TEAM":
    ...
    with col1:
        st.subheader("Yuni")
        st.image("img/yun.jpg")
        st.write("Problem Scoping")
    ...
    with col4:
        st.subheader("Andreas")
        st.image("img/4.jpg") 
        st.write("Modelling dan Evaluation")
